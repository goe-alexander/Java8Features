package chapter_6_6_custom_collectors;

import chapter_6_collectors.CaloricLevel;
...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Partitioned prime number to 100 optimized");
        partitionPrimesWithCustomCollector(100).entrySet().forEach(System.out::println);

    }


    // Old prime implementation
    ...
    public static Map<Boolean, List<Integer>> partitionPrimesWithCustomCollector(int n) {
        return IntStream.rangeClosed(2, n).boxed()
                    .collect(new PrimeNumbersCollector<Integer>());
    }
